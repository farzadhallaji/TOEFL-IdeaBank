...
At work or school, you might encounter a problem that requires creativity -for example, you are given a task to complete that is very different from other tasks you do