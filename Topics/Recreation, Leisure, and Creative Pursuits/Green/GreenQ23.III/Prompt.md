...
Some teenagers take part in different kinds of activities such as musical classes, sports classes and so on, but others only focus on one activity which is important to them